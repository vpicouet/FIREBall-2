...
if __name__ == "__main__":
    ...
    try:
        ...
        temps = get_temps(ser0, ['1','2','3','5','6'])
       # print temps
        ...
        if writeheader:
            fp.write('time,CuClamp1[C],Getter[C],CuClamp2[C],sidetank[C],toptank[C]\n')         # header

        fp.write('{0}, {1:.2f},{2:.2f},{3:.2f},{4:.2f},{5:.2f}\n'.format(time, temps['3'], temps['1'], temps['2'], temps['5'], temps['6']))

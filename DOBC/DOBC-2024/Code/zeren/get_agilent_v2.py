...
if __name__ == "__main__":
    ...
    # open the serial device
        ...
        cmd = chr(0x2)+chr(0x80)+"224"+chr(0x30)+chr(0x3)+cksum
	...
	if not output == '':
		...
		htmsrc= "/home/fireball2/Code/index-fireball-FTS.html"
		dysrc = "/home/fireball2/Code/dygraph-combined.js"
		dylink= "/home/fireball2/data/"+datetime.now().strftime("%y%m%d") + "/dygraph-combined.js"
		html  = "/home/fireball2/data/"+datetime.now().strftime("%y%m%d") + "/index-fireball-FTS.html"

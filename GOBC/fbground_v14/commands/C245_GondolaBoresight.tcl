...
ttk::label $tab.fGondolaBoresight.rotation_value\
    ...
    -anchor center
###
ttk::label $tab.fGondolaBoresight.ra\
    -text "DTU RA:"\
    -font {Helvetica 14 bold} 

ttk::label $tab.fGondolaBoresight.ra_value\
    -textvariable "var::gra"\
    -font {Helvetica 14 bold} \
    -foreground blue\
    -anchor center

ttk::label $tab.fGondolaBoresight.dec\
    -text "DTU Dec:"\
    -font {Helvetica 14 bold} 

ttk::label $tab.fGondolaBoresight.dec_value\
    -textvariable "var::gdec"\
    -font {Helvetica 14 bold} \
    -foreground blue\
    -anchor center

ttk::label $tab.fGondolaBoresight.roll\
    -text "DTU Roll:"\
    -font {Helvetica 14 bold} 

ttk::label $tab.fGondolaBoresight.roll_value\
    -textvariable "var::groll"\
    -font {Helvetica 14 bold} \
    -foreground blue\
    -anchor center
###
...
grid $tab.fGondolaBoresight.rotation_value\
    ...
    -column 2
####
grid $tab.fGondolaBoresight.ra\
    -in $tab.fGondolaBoresight\
    -row 4\
    -column 1

grid $tab.fGondolaBoresight.ra_value\
    -in $tab.fGondolaBoresight\
    -row 4\
    -column 2

grid $tab.fGondolaBoresight.dec\
    -in $tab.fGondolaBoresight\
    -row 5\
    -column 1

grid $tab.fGondolaBoresight.dec_value\
    -in $tab.fGondolaBoresight\
    -row 5\
    -column 2

grid $tab.fGondolaBoresight.roll\
    -in $tab.fGondolaBoresight\
    -row 6\
    -column 1

grid $tab.fGondolaBoresight.roll_value\
    -in $tab.fGondolaBoresight\
    -row 6\
    -column 2
####

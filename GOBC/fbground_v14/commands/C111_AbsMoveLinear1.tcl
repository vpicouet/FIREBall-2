set ns "C111"
namespace eval $ns {
variable commandID 111


# -----------------------------
# pathname for the controls
# -----------------------------
set tab $positions::LinearStageTab1
...
# Namespace Variables
# -----------------------------
variable commandName "Linear stage 1 absolute"
...
iwidgets::regexpfield $tab.fLinearStage1.pos \
    -regexp {^[\-\.0-9]+$}\
    -labeltext "abspos (mm):"\
    -textvariable "${ns}::pos" \
    -width 8
...
button $tab.fLinearStage1.b$suffix \
    -text "Abs. Pos A" \
...
grid $tab.fLinearStage1.b$suffix \
...
# ----------------------------
tooltip::tooltip $tab.fLinearStage1.b$suffix $tthelp

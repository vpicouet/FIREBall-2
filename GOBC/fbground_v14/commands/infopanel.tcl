namespace eval infopanel { 
    ...
    ttk::label $tab.temperatureframe.aigobctemp\
        -text "GOBC T (C):"\
        -justify left

    ttk::label $tab.temperatureframe.aigobctempvar\
        -textvariable var::ai_gobc_temp\
        -justify left

    ttk::label $tab.temperatureframe.aigobcpres\
        -text "GOBC P (mbar):"\
        -justify left

    ttk::label $tab.temperatureframe.aigobcpresvar\
        -textvariable var::ai_gobc_pressure\
        -justify left
   ...
   grid $tab.temperatureframe.aigobctemp\
        -in $tab.temperatureframe\
        -row 5\
        -column 0

   grid $tab.temperatureframe.aigobctempvar\
        -in $tab.temperatureframe\
        -row 5\
        -column 1
	 
	grid $tab.temperatureframe.aigobcpres\
        -in $tab.temperatureframe\
        -row 6\
        -column 0

   grid $tab.temperatureframe.aigobcpresvar\
        -in $tab.temperatureframe\
        -row 6\
        -column 1

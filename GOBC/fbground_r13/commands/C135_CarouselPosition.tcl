...
"
    ...
    variable carousel 0
    #variable poslist { "Tilted (-1)" "Straight (39)" "Diagonal (79)" " Field 1 (119)" "Field 4 (159)" "Field 2 (-161)" "Field 3 (-121)" "Grid ( -81)" "Open (-41)" }
    variable poslist { "Long Slit (-141)" "QSO (-101.25)" "Field 1 (-61.1)" " Field 4 (-21)" "Field 2 (20)" "Field 3 (59.5)" "Grid (99)" "Open (139)" "Tilted (179)" }
...
proc myfunction {} {
    ...
    set commandQuestion \
"Do you want to laod carousel position:

...
variable shutterBName "Cap Shutter"
variable shutterCName "Int. Fiber Shutter"
variable shutterDName "Cap Fiber Shutter"
...
ttk::label $tab.tsensor.tsensorAtxt\
    -text "Sensor A status: "\
    -justify right

ttk::label $tab.tsensor.tsensorAvar\
    -textvariable var::sensorAstatus\
    -anchor center\
    -relief sunken\
    -width 10

ttk::label $tab.tsensor.tsensorBtxt\
    -text "Sensor B status: "\
    -justify right

ttk::label $tab.tsensor.tsensorBvar\
    -textvariable var::sensorBstatus\
    -anchor center\
    -relief sunken\
    -width 10
